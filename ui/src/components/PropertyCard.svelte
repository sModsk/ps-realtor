...
>
	...
	{#if property.extra_imgs && property.extra_imgs[0] && property.extra_imgs[0].url}
		<img
			src={property.extra_imgs[0].url}
			alt=""
			class="w-full h-[20rem] object-cover object-center"
		/>
		{:else if $SHELLS[property.shell] && $SHELLS[property.shell].imgs && $SHELLS[property.shell].imgs[0]}
		<img
			src={$SHELLS[property.shell].imgs[0].url}
			alt=""
			class="w-full h-[20rem] object-cover object-center"
		/>
		{:else}
